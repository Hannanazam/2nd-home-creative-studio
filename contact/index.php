      ...
      <nav class="navbar navbar-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav text-end ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              ...
              <button type="button" id="sendbutton" class="btn btn-outline-dark shadow-none showonmedium">SEND</button>
          ...
          <button type="submit" class="btn btn-outline-dark shadow-none hideonmedium">SEND</button>
